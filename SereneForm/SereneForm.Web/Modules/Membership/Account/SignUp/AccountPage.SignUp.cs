...
using SereneForm.Administration;
using SereneForm.Administration.Entities;
using SereneForm.Administration.Repositories;
using SereneForm.Common;
using Serenity;
using Serenity.Data;
...
namespace SereneForm.Membership.Pages
{
